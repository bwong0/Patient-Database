 ...
 */
	...
	// Postcondition: If aCareCard does not have 10 digits, then care card is set to "0000000000".
	//                All other data members set to "To be entered".
	Patient(string aCareCard, string aName, string address);

	// Description: Create a patient with the given care card number, name, address and phone
	// Postcondition: If aCareCard does not have 10 digits, then care card is set to "0000000000".
	//                All other data members set to "To be entered".
	Patient(string aCareCard, string aName, string address, string phone);

	// Description: Create a patient with the given care card number, name, address,phone and email
	// Postcondition: If aCareCard does not have 10 digits, then care card is set to "0000000000".
	//              
	Patient(string aCareCard, string aName, string address, string phone, string email);
